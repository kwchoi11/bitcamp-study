...
public class MemberHandler implements Handler {
  ...
  private String inputHand(String hand) {
    ...
    while (true) {
      String menuNo2 = this.prompt.inputString(
          label
          + "  1. 우투우타\n"
          + "  2. 우투좌타\n"
          + "  3. 좌투좌타\n"
